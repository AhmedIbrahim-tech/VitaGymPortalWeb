        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AnnualAllowanceDays = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("LeaveType_AnnualAllowanceCheck", "AnnualAllowanceDays >= 0");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BuildingNumber = table.Column<string>(type: "varchar(20)", maxLength: 20, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AnnualLeaveBalanceDays = table.Column<int>(type: "int", nullable: false, defaultValue: 0),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    Name = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: false),
                    Email = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("MemberShip_DateCheck", "StartDate < EndDate");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("LeaveRequest_DateCheck", "StartDate <= EndDate");
                    table.CheckConstraint("LeaveRequest_TotalDaysCheck", "TotalDays > 0");
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_LeaveRequests_Trainers_TrainerId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("Session_CapacityCheck", "Capacity between 1 and 100");
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TrainerPayrolls", x => x.Id);
                    table.CheckConstraint("TrainerPayroll_PeriodCheck", "PeriodStart < PeriodEnd");
                    table.ForeignKey(
                        name: "FK_TrainerPayrolls_Trainers_TrainerId",
                        column: x => x.TrainerId,
                        principalTable: "Trainers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LeaveRequests_TrainerId",
                table: "LeaveRequests",
                column: "TrainerId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TrainerPayrolls_TrainerId",
                table: "TrainerPayrolls",
                column: "TrainerId");
