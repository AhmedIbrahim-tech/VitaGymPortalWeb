...
{
    public class TrainerToUpdateViewModelValidator : AbstractValidator<TrainerToUpdateViewModel>
    {
        public TrainerToUpdateViewModelValidator()
        {
            RuleFor(x => x.Email)
                .NotEmpty()
            ...
            RuleFor(x => x.BuildingNumber)
                ...
                .WithMessage("Building number must be > 1");
